...
export default function Signup() {
  ...
  const inputClasses = "w-full px-4 py-3.5 rounded-xl border border-border/50 bg-background/80 text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-transparent transition-all font-medium"
